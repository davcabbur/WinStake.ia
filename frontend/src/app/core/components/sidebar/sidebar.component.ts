...
@Component({
  ...
  template: `
    ...
    <div class="overlay" *ngIf="ui.sidebarOpen()" (click)="ui.closeSidebar()"></div>
  ...
  styles: [`
    ...
    .version { margin-top: 8px; font-size: 11px; color: var(--text-secondary); opacity: 0.5; }

    .dot { width: 8px; height: 8px; background: var(--status-success-text); border-radius: 50%; }
